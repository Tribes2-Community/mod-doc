...
TacoServer (section 28) ships its own `DMGame.cs` — 970 lines against base's 374, roughly two and a half
...
Classic's Spawn CTF (section 31) into a Deathmatch context nearly twenty years later. It is a small
...
- [08 · The base ruleset](../08-base-ruleset/README.md) — the constants and conventions every gametype extends
- [31 · Capture the Flag](../31-capture-the-flag/README.md) — Spawn CTF, the origin of TacoServer's midair bonus
- [28 · TacoServer](../28-tacoserver/README.md) — the modern codebase this page's descendant lives in
