...
[24 · The ruleset toggles](../24-classic-ruleset-toggles/README.md) — except this one shipped in base,
...
- [24 · The ruleset toggles](../24-classic-ruleset-toggles/README.md) — the same vote/admin-override toggle shape, in Classic's context
- [34 · Bounty](../34-bounty/README.md) — another gametype with per-player rather than shared state
- [Gametypes](../05-gameplay-systems/gametypes.md) — `MissionTypes`, package activation
- [39 · Team Rabbit 2](../39-team-rabbit-2/README.md) — flag-passing pushed much further, with a scored bonus matrix
