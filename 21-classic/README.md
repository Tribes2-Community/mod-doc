...
| Page | Read it for |
|---|---|
| [22 · Classic 1.1](../22-classic-1-1/README.md) | The version in your 25034 install — what it changed and why |
| [23 · Classic 1.5.2](../23-classic-152/README.md) | The 2004-onward baseline ruleset every modern server starts from |
| [24 · The ruleset toggles](../24-classic-ruleset-toggles/README.md) | `$Host::ClassicLoad*` — optional rules as a shipped mechanism, and how to steal it |
| [25 · Evolution Admin Mod](../25-evolution-admin-mod/README.md) | Architecture — the `.ovl` files and the generated package |
| [26 · Evolution in operation](../26-evolution-operation/README.md) | 89 prefs, the chat console, and time-leased SuperAdmin |
| [27 · teratos' evoClassic](../27-teratos-evoclassic/README.md) | A one-line fix, ten years later, and what it teaches |
| [28 · TacoServer](../28-tacoserver/README.md) | The modern codebase — lineage, `NoEvo`, and the overlay model |
| [29 · TacoServer in operation](../29-tacoserver-operation/README.md) | The 21 autoexec features, prefs, and running it |
| [30 · Running Classic today](../30-running-classic-today/README.md) | Choosing a codebase in 2026, and what to build on |
...
and ideas; 1.5.2 contributed the code. Section 28 evidences this.
...
constraint — Evolution with generated packages (section 25), TacoServer with per-feature autoexec scripts
(section 28).
