...
The sibling of [64 · CCM](../64-ccm/README.md) — **78 % identical to it** — and the one fork in this family
...
Every other Construction derivative documented in sections 59–68 installs as `GameData/Construction/`.
...
See [64 · CCM](../64-ccm/README.md#what-it-added) for that inventory rather than duplicating it here.
...
- [64 · CCM](../64-ccm/README.md) — the sibling, and the full feature inventory
- [58 · The Construction Mod](../58-construction-mod/README.md) — the 0.69a base
