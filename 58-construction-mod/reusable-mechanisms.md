...
**Alternative.** [QuantiumX](../68-quantiumx/README.md) uses chat commands instead (§6). Better for many
...
[QuantiumX](../68-quantiumx/README.md) took this furthest — `/objectscale 2 2 4`, `/objectscale get`,
...
|---|---|---|
| Shadowing 27 base files for a fork that is not a total conversion | Most of 59–68 | Nothing merges; the ecosystem became a fork tree ([What it changed](what-it-changed.md#the-shadowing-strategy)) |
| Rewriting instead of extending | [QuantiumX](../68-quantiumx/README.md), 8 % of base intact | Base documentation stops applying; no fix can be ported in |
| Shipping `.cs` and `.dso` together | [c2kconstruction](../60-c2k-construction/README.md), 520 `.dso` : 218 `.cs` | Edits are silently inert; three DSO-deleter batch files shipped as a workaround |
...
([61 · MooCon](../61-moocon/README.md#the-add-on-system)) is the only structural answer anyone in this
