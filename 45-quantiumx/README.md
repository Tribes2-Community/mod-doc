...
([Building systems](../40-construction-mod/building-systems.md#beacon-key-mode-switching)) — an approach
...
[MooCon](../42-moocon/README.md) has a cash-and-jobs economy,
[Ultimate Build](../47-ultimate-build/README.md) has `RPMoneySettings.cs`, CCM has `RankStuff.cs` and
...
`truPhysics.cs` the same way ([What it changed](../40-construction-mod/what-it-changed.md#new-subsystems)).
...
- **The base documentation stops applying.** Section 40 describes 0.69a; with 91 of its files modified,
...
Compare [44 · Power Edition](../44-power-edition/README.md): comparable new content volume, 82 % of the
...
- **Verify against QuantiumX's own files, not section 40.** With 8 % of the base intact, assume nothing
...
- [44 · Power Edition](../44-power-edition/README.md) — the disciplined counterexample
