...
The reason is the one from section 38: **a server-side mod cannot ship interface to clients.** A player
...
[Reusable mechanisms](../58-construction-mod/reusable-mechanisms.md).
...
the teamkill log's correctness mattered, and why section 47 is about a single line in it.
...
6. **Delete `classic/scripts/evolution/evoPackage.cs` if it exists** (section 45).
...
- [45 · Evolution Admin Mod](../45-evolution-admin-mod/README.md) — the `.ovl` architecture
- [47 · teratos' evoClassic](../47-teratos-evoclassic/README.md) — fixing the teamkill log
...
- [58 · Reusable mechanisms](../58-construction-mod/reusable-mechanisms.md) — chat-command dispatch elsewhere
