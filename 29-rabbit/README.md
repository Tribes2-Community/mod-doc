...
The ancestor gametype behind sections 28 and 39's flag-passing modes, at 739 lines — untouched by
...
A TribalWar community strategy guide to Team Rabbit 2 (Yogi, covered in full in section 30) sketches a
...
- [28 · Hunters & Team Hunters](../28-hunters/README.md) — the other flag-scoring family, return-based rather than hold-based
- [30 · Team Rabbit 2](../30-team-rabbit-2/README.md) — the full evolution: passing, roles, and a scored bonus matrix
