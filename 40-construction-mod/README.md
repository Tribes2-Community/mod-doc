...
Sections 41–48 document the derivatives. **Every one of them fingerprints to 0.69a** — established by
comparing MD5 hashes of each fork's `.cs` files against all three baselines and taking the closest match.

| § | Fork | `.cs` | Identical to 0.69a | New | Removed | Character |
|---|---|---:|---:|---:|---:|---|
| [44](../44-power-edition/README.md) | Power Edition | 155 | **82 %** | 45 | 0 | Purely additive weapons pack |
| [48](../48-c2k-construction/README.md) | c2kconstruction | 219 | 67 % | 109 | 0 | Construction + the Tricon 2 admin suite |
| [42](../42-moocon/README.md) | MooCon 1.7.0 | 125 | 62 % | 18 | 3 | Light fork, tooling focus |
| [41](../41-metallic-construction/README.md) | Metallic Construction 1.4 | 153 | 38 % | 59 | 16 | Building features + RPG elements |
| [43](../43-ccm/README.md) | CCM | 166 | 34 % | 74 | 18 | Combat/construction hybrid |
| [46](../46-tccm/README.md) | TCCM | 169 | 32 % | 77 | 18 | CCM sibling, own install name |
| [47](../47-ultimate-build/README.md) | Ultimate Build 2.0 | 149 | 27 % | 50 | 11 | RP economy, bundles Tricon 2 |
| [42](../42-moocon/README.md) | MooCon 1.9.0 | 113 | 21 % | 58 | 55 | Full tree reorganisation |
| [42](../42-moocon/README.md) | MooCon Final | 115 | 19 % | 60 | 55 | Increment on 1.9.0 |
| [45](../45-quantiumx/README.md) | QuantiumX | 199 | **8 %** | 99 | 10 | Near-total rewrite |

Read that column as *how much of 0.69a survives untouched*. A high number is not a criticism — Power
Edition is additive by design and all the better for it. A low number means the fork rewrote the base
rather than extending it, which makes merging anything back essentially impossible.
