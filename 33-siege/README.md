...
`FlipFlop` is the same switch object DnD holds for continuous points (section 32); here, touching it while
...
the line noted in [23 · Classic 1.5.2](../23-classic-152/README.md): "Added some asset scoring to Siege,
...
mode's spawn-wait countdown (section 08), applied at gametype level rather than server level.
...
- [32 · Defend and Destroy](../32-defend-and-destroy/README.md) — the `FlipFlop` object's other scoring model
- [31 · Capture the Flag](../31-capture-the-flag/README.md) — the same per-object-to-generic consolidation pattern
- [23 · Classic 1.5.2](../23-classic-152/README.md) — "Added some asset scoring to Siege," implemented here
- [08 · The base ruleset](../08-base-ruleset/README.md#tournament-mode) — the readiness-countdown convention `voteMatchStart` follows
