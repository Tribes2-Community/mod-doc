...
continuous rate, the same scoring shape Defend and Destroy uses for its switches (section 23). Multiple
...
- [23 · Defend and Destroy](../23-defend-and-destroy/README.md) — the same continuous per-second hold-scoring shape
- [25 · Bounty](../25-bounty/README.md) — the other gametype Classic leaves entirely unmodified
