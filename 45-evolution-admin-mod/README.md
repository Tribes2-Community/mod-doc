...
outright (section 37). An admin mod that also wants to change `defaultGame.cs` therefore cannot simply
...
- [46 · Evolution in operation](../46-evolution-operation/README.md) — prefs, chat console, leasing
- [47 · teratos' evoClassic](../47-teratos-evoclassic/README.md) — the one-line fix
