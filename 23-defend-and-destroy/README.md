# 23 · Defend and Destroy

The Tribes 1 gametype restored, and the strongest evidence in this handbook that Sierra absorbed Classic's
work directly into the retail product — see [31 · The base ruleset](../31-base-ruleset/README.md#the-dnd-anomaly)
and [38 · Classic 1.1](../38-classic-1-1/README.md) for the full provenance story. This page covers the
...
every building. Consistent with section 31's framing of the MPB as a serious mobile asset, and with the
"deployable, high-value objective" that other gametypes and mods (Construction's power-frequency systems,
section 58) treat mobile infrastructure as.
...
longer incurs a -10 penalty to a players score" (section 38). Both files are z0dd's, dated the same
...
- [31 · The base ruleset](../31-base-ruleset/README.md#the-dnd-anomaly) — the provenance evidence: shipped in base, authored by Classic's z0dd
- [38 · Classic 1.1](../38-classic-1-1/README.md) — the suicide-penalty change this page's comment explains
- [22 · Capture the Flag](../22-capture-the-flag/README.md) — the per-object scoring style DnD shares with base CTF
- [Gametypes](../05-gameplay-systems/gametypes.md) — `MissionTypes`, package activation
- [58 · The Construction Mod](../58-construction-mod/README.md) — another system built around defensible infrastructure
