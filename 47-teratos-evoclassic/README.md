...
reflecting Evolution's own descent from Pizza Admin Mod (section 45).
...
1.2.3c-family mod. Everything in [section 46](../46-evolution-operation/README.md) applies unchanged,
including the WON-identity problem that limits the leasing system on a modern patched install. If you are
standing up a server today, [section 50](../50-running-classic-today/README.md) is the relevant page —
the Evolution line is documented here for what it teaches, not as a current recommendation.

## Related

- [45 · Evolution Admin Mod](../45-evolution-admin-mod/README.md) — the `.ovl` architecture this patches
- [46 · Evolution in operation](../46-evolution-operation/README.md) — the logging surface it belongs to
