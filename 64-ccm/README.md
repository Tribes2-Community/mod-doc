...
| Sibling | [65 · TCCM](../65-tccm/README.md) — 78 % identical to CCM |
...
CCM and [TCCM](../65-tccm/README.md) are **78 % identical** at file level. The differences are small:
...
- [65 · TCCM](../65-tccm/README.md) — the sibling
