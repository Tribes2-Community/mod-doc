...
`vehicle_SkyBase.cs` ([41 · Metallic Construction](../41-metallic-construction/README.md)). Two forks
...
It is worth contrasting with [45 · QuantiumX](../45-quantiumx/README.md), which achieves a comparable
...
- [45 · QuantiumX](../45-quantiumx/README.md) — the same job done the opposite way
