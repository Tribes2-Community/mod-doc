...
run** — which is exactly what TacoServer does when it ships a curated `serverPrefs.cs` (section 49)
rather than exposing everything.

## Related

- [39 · Classic 1.5.2](../39-classic-152/README.md) — the release that introduced these
...
- [49 · TacoServer in operation](../49-tacoserver-operation/README.md) — the modern successor to this idea
