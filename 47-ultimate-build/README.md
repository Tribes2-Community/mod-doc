...
identifiable and removable. Compare [Power Edition](../44-power-edition/README.md)'s `PowerPack/start.cs`;
...
[c2kconstruction](../48-c2k-construction/README.md), documents the setup **[mod-script]**:
...
[48 · c2kconstruction](../48-c2k-construction/README.md#tricon-2). Two independent forks bundling the same
...
progression system in this family, alongside [MooCon](../42-moocon/README.md)'s `CashScripts/` with
`jobs.cs`, [QuantiumX](../45-quantiumx/README.md)'s `rpgFunctions.cs`, and [CCM](../43-ccm/README.md)'s
`RankStuff.cs`.
...
shadowing ([What it changed](../40-construction-mod/what-it-changed.md#the-shadowing-strategy)) stated as
...
- **69 changed base files** means section 40's description of baseline behaviour needs verifying against
...
- [48 · c2kconstruction](../48-c2k-construction/README.md) — the other Tricon 2 host
- [44 · Power Edition](../44-power-edition/README.md) — the same subtree discipline, applied throughout
