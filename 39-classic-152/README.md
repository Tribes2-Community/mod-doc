# 39 · Classic 1.5.2 — the baseline ruleset
...
| `weapons/blaster.cs` | Needed once the blaster became toggleable (section 40) |
...
configuration rather than as a fork. Section 40 is where that becomes systematic.
...
That `ilys` cluster reappears in Evolution as the **AntiLou** fix set (section 45) and in TacoServer as
`autoexec/AntiLouExploitFixes.cs` (section 48). The same body of security work propagates through all
...
[38 · Classic 1.1](../38-classic-1-1/README.md#the-physics-change-skiing-friction-and-momentum)
...
1.5.2 predates TribesNEXT and RC2a. It runs unmodified under both, and every codebase in sections 45–50
...
- [40 · The ruleset toggles](../40-classic-ruleset-toggles/README.md) — the `$Host::ClassicLoad*` system 1.5 introduced
- [38 · Classic 1.1](../38-classic-1-1/README.md) — what 1.5.2 descends from
- [45 · Evolution Admin Mod](../45-evolution-admin-mod/README.md) — the admin layer built for 1.4.1–1.5.1
- [48 · TacoServer](../48-tacoserver/README.md) — the modern overlay on 1.5.2
