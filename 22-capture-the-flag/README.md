...
own missions carry a `CTF_scoreLimit` field too (section 30), reused for an unrelated gametype's win
...
Classic's own 1.4 changelog refers to as "Optimized code in various files" (section 39) — visible here as
...
| Function | What it is |
|---|---|
| `CTFGame::antiTurtle`, `sendAntiTurtleTimeList`, `voteAntiTurtleTime` | The anti-turtling feature — flags auto-return after `$Host::ClassicAntiTurtleTime` minutes, disabled in tournament mode. See [39 · Classic 1.5.2](../39-classic-152/README.md) |
...
Classic's own readme credits the same person by name, in the flag-changes section (section 38): *"Added
...
credited in `TR2Game.cs`'s own header as Team Rabbit 2's "Designer, Lead Programmer, Maps" (section 30) —
...
own gametypes (`LCTFGame.cs`, section 48) assume as normal.
...
- [31 · The base ruleset](../31-base-ruleset/README.md) — `defaultGame.cs` and the package convention CTF follows
- [39 · Classic 1.5.2](../39-classic-152/README.md) — the anti-turtling feature this page's code implements
- [30 · Team Rabbit 2](../30-team-rabbit-2/README.md) — KineticPoet's other credited contribution
- [Gametypes](../05-gameplay-systems/gametypes.md) — `MissionTypes`, package activation
- [48 · TacoServer](../48-tacoserver/README.md) — `LCTFGame.cs`, a modern descendant
