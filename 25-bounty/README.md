...
- [23 · Defend and Destroy](../23-defend-and-destroy/README.md) — the same named-constant scoring convention
- [30 · Team Rabbit 2](../30-team-rabbit-2/README.md) — another gametype with per-player, non-global state (roles, not colours)
