...
discipline axis, c2kconstruction sits with [44 · Power Edition](../44-power-edition/README.md) rather than
...
- **Shipping both `.cs` and `.dso` is the configuration this handbook warns against.** The engine prefers
  ...
  ([What it changed](../40-construction-mod/what-it-changed.md#the-dso-problem-at-scale)).
...
bundled into [47 · Ultimate Build 2.0](../47-ultimate-build/README.md) as `.vl2` archives without
conflict.
...
is in [47 · Ultimate Build 2.0](../47-ultimate-build/README.md#tricon-2).
...
- **67 % of the base is intact** — section 40's description of baseline Construction is more reliable here
...
- [47 · Ultimate Build 2.0](../47-ultimate-build/README.md) — the other Tricon 2 host
